#!/usr/bin/env bash
# m4a.sh - Converts flac files to M4A, preserving folder structure.
# Input:  Music/export/tag/flac
# Output: Music/export/tag/m4a (same structure)
...
while IFS= read -r -d '' INPUT; do
    ...
    BASENAME_NOEXT="${REL%.*}"
    OUTPUT_PATH="$OUTPUT_ROOT/$BASENAME_NOEXT.m4a"
